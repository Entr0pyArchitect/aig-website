-- Product category, ticketing, and popularity metrics upgrade.
-- Adds cybersecurity catalog items from the public cybersecurity services/products catalog.
-- Idempotent for existing local/remote D1 databases.
